...
{
    class DefaultEllipseDrawingMethod : AbstractDrawingMethod
    {
        ...
        {
            context.DrawEllipse(null, pen, new System.Windows.Point(DrawingMethod.CenterX, DrawingMethod.CenterY), DrawingMethod.HorizontalLength, DrawingMethod.VerticalLength);
        }
    }
}
